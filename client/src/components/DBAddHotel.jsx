...
import { options, statuses } from "../utils/styles";
...
import { addNewhotel, getAllHotels } from "../api";
    ...
    <div className="flex items-center justify-center flex-col gap-6 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4">
        <InputValueField
          ...
          stateValue={hotelName}
          stateFunc={setHotelName}
        />
            ...
            <div className="w-full h-full flex flex-col items-center justify-evenly px-24">
              ...
              {Math.round(progress > 0) && (
                <div className="w-full flex flex-col items-center justify-center gap-2">
                  ...
                  <div className=" w-full bg-gray-200 rounded-s-full h-2.5">
                    <div
